...
#adding more features only raises our testing rate slightly. we can only achieve an accuracy rating of around 75-80 percent.
#it is possible that we cannot get any higher because to some extent, words are only so correlated with the rating - 
#in example, the word 'love' may appear pretty frequently in both 4 and 5 star reviews, making it difficult for the model
